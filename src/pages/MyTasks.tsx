...
export function MyTasks() {
  ...
  return (
    <div className="p-4 md:p-6 h-full overflow-y-auto">
      <div className="mb-6">
        <h1 className="text-xl md:text-2xl font-bold text-foreground">My Tasks</h1>
        <p className="text-sm md:text-base text-muted-foreground">View and manage your assigned tasks</p>
      </div>
